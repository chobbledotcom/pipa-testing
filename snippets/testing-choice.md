...
blocks:
  - type: section-header
    ...
    intro: |
      ...
      The right route depends on whether the equipment falls within the PIPA scheme. You do not need to work that out alone: send the office the make, model and a photo if you are unsure.
  - type: split-full
    ...
    right_button:
      text: Explore in-house inspections
      href: /standard-test/
      variant: secondary
---
