...
blocks:
  - type: image-background
    ...
    content: |
      ...
      [Book with Dave](tel:+447990520545){ .button .primary } [Why PIPA?](/safety/){ .button .ghost }
  - type: section-header
    intro: |
      ## Test / inspection
  ...
  - type: features
    ...
    items:
      ...
      - icon: mdi:basketball
        name: Football shootouts &amp; basketball hoops
        description: PIPA tags issued for non-ride-on inflatable games.
      - icon: mdi:bullseye-arrow
        name: Axe-throwing &amp; archery
  ...
  - type: split-callout
    content: |
      ...
      The PIPA scheme delivers improved safety, HSE-recognised best practice, quality assurance, and certified initial &amp; annual testing.
  ...
  - type: cta
    content: |
      ## Book your PIPA test with Dave

      Call **07990 520545** direct or the office on **01428 751925**.
    button:
      text: Contact us
      href: /contact/
      variant: secondary
