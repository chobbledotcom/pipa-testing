...
blocks:
  ...
  - type: section-header
    ...
    intro: |
      ...
      A tag connects an eligible inflatable to its inspection record in the PIPA database. It gives operators and venues a practical way to check whether the recorded test is current.
  - type: features
    compact: true
    items:
      - icon: mdi:clipboard-check
        name: Recorded inspection
  ...
  - type: faqs
    ...
    items:
      ...
      - question: What if I am unsure whether a test is current?
        answer: Check the unit details against the PIPA database where applicable, or ask Dave to review the tag and paperwork with you.
  - type: snippet
